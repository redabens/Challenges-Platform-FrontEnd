    ...
    <div class="bg-white rounded-md p-8 w-full max-w-md">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <fwb-input
          type="email"
          v-model="emailInput"
          placeholder="Enter a team member's email"
          label="Add Member"
        ...
        <fwb-button class="mt-4 w-full" size="lg" color="default"
          >Create Team</fwb-button
        >
      </form>
    </div>
  </div>
...
const handleSubmit = () => {
  ...
  router.push({ name: "Team", params: { teamId: 1 } });
